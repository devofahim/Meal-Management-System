...
<body>
    <div class="container">
        <h4>Meals History - Current Month</h4>
        <table id="customers">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                $result = mysqli_query($conn, "SELECT username, totalmeals, meal_date FROM meals WHERE meal_date != '0000-00-00' ORDER BY meal_date DESC");
                ...
                if (mysqli_num_rows($result) > 0) {
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td>' . date('d-m-Y', strtotime($row['meal_date'])) . '</td>';
                    echo '</tr>';
                  }
    ...
    <div class="container">
        <h4>Deposit History - Current Month</h4>
        <table id="customers">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                // Execute the query to select all rows from the "meals" table
                $result = mysqli_query($conn, "SELECT username, deposit, deposit_date FROM meals WHERE deposit_date != '0000-00-00' ORDER BY deposit_date DESC");
