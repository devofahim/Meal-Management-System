...
$bazar_date = mysqli_real_escape_string($conn, $_POST["bazar_date"]);



// Insert values into meals table
$sql = "INSERT INTO meals (username, bazar_details,bazarcost, bazar_date) VALUES ('$username', '$bazar_details', '$bazarcost', '$bazar_date')";
